...
from .views import change_password, check_passwords, collect_password, edit_profile, edit_profile_image, find_email, forgot_password, password_validation, send_message, signup, email_validation, username_validation, match_passwords,send_otp,check_otp, Login, logout, profile
