...
from core.api import PublicAPI
from .views import FollowNotification, PostNotification, RemoveNotification, bulletin_registration, bulletin_unsubscribe, delete_post, index, about, like_dislike_post, new_post, new_series, privacy_policy, refund_policy, series, single, contact, search, category, tag, terms_conditions, update_post, sponsor
...
urlpatterns = [
    ...
    path('categories/<category_slug>', category, name='category'),
    ...
    path('api/v1/posts', public_api.all_posts, name='public_api'),
    path('api/v1/<str:username>/posts', public_api.user_posts, name='pub_user_posts_api'),
    path('api/v1/post/<int:post_id>/<str:slug>', public_api.single_post, name='pub_single_post_api'),
